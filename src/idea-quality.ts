...
const REAL_WORKFLOW_ACTOR_TERMS = [
  '車商', '業務', 'pm', 'product manager', '產品經理', 'product designer', '設計師', 'designer', 'ux researcher',
  'researcher', '店家', '創作者', 'creator', '消防', 'firefighter', '學員', 'student', '公部門', '玩家', 'npc',
]
...
const REAL_WORKFLOW_DETAIL_TERMS = [
  ...
  'invoice', 'receipt', 'car', 'cars', 'vehicle', 'vehicles', 'listing', 'listings', 'photography', '8891', 'facebook',
  'erp', 'crm', 'cad', 'onshape', 'pkm', 'personal knowledge', 'knowledge management',
  '知識管理', '日記', 'journal',
]
...
const REAL_WORKFLOW_ACTION_TERMS = [
  ...
  'cross-post', 'cross-posting', 'cross posting', 'repetitive', 'tag',
  'tags', 'tagging', 'summarize', 'summarizes', 'summarise', 'summarises', 'handoff', 'review', 'friction', 'pain',
]
...
export function getReflectionSeedQualityRejection(
  ...
  const hasRealWorkflow = hasWorkflowDetail && hasWorkflowAction && (hasWorkflowActor || workflowDetailCount >= 2)
